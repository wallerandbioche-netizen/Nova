...
export const DEMO_NEWS: DemoNewsItem[] = [
  {
    ...
    body:
      'Le conseil des gouverneurs a décidé de maintenir le taux de dépôt à son niveau actuel. Le communiqué insiste sur une approche « réunion par réunion » et sur la dépendance aux données. Les marchés obligataires européens ont réagi modérément. La trajectoire exacte des prochaines décisions reste incertaine.',
  ...
  },
  {
    ...
    body:
      'La désinflation se poursuit, principalement sous l’effet de la composante énergie. L’inflation sous-jacente, qui exclut l’énergie et l’alimentation, recule plus lentement. Les économistes divergent sur la persistance de cette tendance.',
  ...
  },
  {
    ...
    body:
      'Le Brent gagne environ 3 % sur la séance. Les entreprises fortement consommatrices d’énergie et les compagnies de transport sont traditionnellement sensibles à ce type de mouvement, à la hausse comme à la baisse. L’ampleur et la durée de cette évolution ne sont pas connues.',
  ...
  {
    title: 'Les valeurs technologiques reculent après des résultats mitigés dans les semi-conducteurs',
    summary:
      'Un acteur majeur des équipements pour semi-conducteurs publie des commandes inférieures aux attentes du consensus.',
    body:
      'Le titre recule en séance, entraînant plusieurs valeurs du secteur. La direction évoque un décalage de commandes plutôt qu’une baisse de la demande finale, une interprétation que tous les analystes ne partagent pas.',
  ...
  },
  {
    ...
    body:
      'Un dollar plus fort mécaniquement augmente la valeur en euros des actifs libellés en dollars pour un investisseur de la zone euro, et inversement. Cet effet de change est distinct de la performance propre des actifs concernés.',
  ...
  {
    title: 'Un projet de réglementation européenne encadre davantage les frais des fonds distribués aux particuliers',
    summary:
    ...
    body:
      'Le calendrier d’adoption et le contenu final du texte ne sont pas arrêtés. Les sociétés de gestion et les distributeurs seraient les premiers concernés. Les conséquences pour les investisseurs particuliers dépendront de la version définitive.',
  ...
  {
    title: 'Tensions commerciales : de nouveaux droits de douane envisagés sur certains composants électroniques',
    summary:
      'Des discussions portent sur l’instauration de droits de douane visant une catégorie de composants importés.',
    body:
      'Les chaînes d’approvisionnement de l’électronique grand public et de l’industrie pourraient être concernées. À ce stade, il s’agit d’un projet : ni le périmètre ni le calendrier ne sont confirmés.',
  ...
  },
  {
    ...
    body:
      'La hausse s’explique en partie par les marges d’intérêt. Les banques rappellent que cet effet dépend du niveau des taux, qui peut évoluer. Le coût du risque reste un point de vigilance mentionné par les directions.',
  ...
  },
  {
    ...
    body:
      'Un recul des rendements correspond mécaniquement à une hausse du prix des obligations déjà émises. L’effet sur un portefeuille dépend de la duration des obligations détenues, directement ou via un fonds.',
  ...
  },
  {
    ...
    body:
      'Les mouvements de l’or sont souvent commentés comme un indicateur d’aversion au risque. Cette lecture est une interprétation courante, pas une règle vérifiée à chaque épisode de marché.',
    source: 'Dépêche matières premières de démonstration',
    sourceUrl: null,
    hoursAgo: 34,
    category: 'commodities',
  ...
  },
  {
    ...
    body:
      'La direction évoque un effet de comparaison avec un trimestre précédent exceptionnel. Les analystes restent partagés sur la durée de ce ralentissement.',
  ...
  },
  {
    ...
    body:
      'Les variations des cryptoactifs sont généralement plus amples que celles des actions. Une position, même modeste, peut donc peser sur la variation quotidienne d’un portefeuille.',
