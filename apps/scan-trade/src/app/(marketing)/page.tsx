...
const STEPS = [
  {
    ...
    title: 'Upload',
    description:
      'Envoie une capture de ton graphique. JPG, PNG ou WEBP, depuis ton ordinateur ou ton téléphone.',
  },
  {
    number: '02',
    title: 'Scan',
    ...
    <>
        ...
        <div className="relative mx-auto w-full max-w-6xl px-4 pb-16 pt-16 sm:px-6 sm:pb-24 sm:pt-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-content-muted sm:text-lg">
              Transforme une simple capture d&apos;écran en analyse structurée de ton graphique,
              avec les niveaux clés et un scénario potentiel.
            </p>

            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <ButtonLink
                href={viewer ? '/analyses/nouvelle' : '/inscription'}
                size="lg"
      ...
      <section className="border-t border-border bg-surface/30 py-20 sm:py-24">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-xl text-content-muted">
            Un outil d&apos;analyse n&apos;a de valeur que s&apos;il sait dire ce qu&apos;il ne sait
            pas.
          </p>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12">
            <PricingCard
              action={
                <ButtonLink
                  href={viewer ? '/abonnement' : '/inscription'}
                  size="lg"
                  className="w-full"
                >
