  ...
  return (
    <Card tone="raised" className="overflow-hidden">
      ...
      <dl className="divide-y divide-border">
        ...
        <Row
          label="Take Profit 1"
          value={formatPrice(analysis.takeProfit1)}
          accent="accent"
          emphasis
        />
        {analysis.takeProfit2 != null && (
          <Row
            label="Take Profit 2"
            value={formatPrice(analysis.takeProfit2)}
            accent="accent"
            emphasis
          />
        )}
      ...
      {analysis.invalidation && (
        <div className="border-t border-border bg-surface/60 px-5 py-4 sm:px-6">
          <p className="text-xs font-medium uppercase tracking-[0.14em] text-content-faint">
            Invalidation
          </p>
      ...
      <p className="border-t border-border px-5 py-3.5 text-xs leading-relaxed text-content-faint sm:px-6">
        Niveaux potentiels issus de l&apos;analyse de la capture. Scan Trade ne place et
